...
# # ─── Page Config ───────────────────────────────────────────────────────────────
# st.set_page_config(
#     page_title="AutoVal · Price Estimator",
#     page_icon="🚗",
#     layout="centered",
...
#   background: var(--bg) !important;
#   background-image:
#     radial-gradient(ellipse 60% 40% at 50% 0%, rgba(232,255,71,0.04) 0%, transparent 65%),
#     radial-gradient(ellipse 30% 20% at 100% 100%, rgba(255,107,53,0.05) 0%, transparent 55%) !important;
# }
...
#   <div class="ah-eyebrow">Ridge · Polynomial · Degree 2</div>
#   <div class="ah-title">Auto<span>Val</span></div>
#   <div class="ah-sub">Instant market price intelligence</div>
# </div>
# """, unsafe_allow_html=True)
...
#   AutoVal · Ridge Poly · CarPrice Assignment · scikit-learn
# </div>
# """, unsafe_allow_html=True)
